...
public class UserController {
	...
	@RequestMapping("/home")
	public String home(HttpSession session, Followers followers, HttpServletRequest req, Model model,
			Following following, Post post, @ModelAttribute("like") Likes like,
...
//  		model.addAttribute("Comments",comments);
	...
	public String ProfilePage(HttpSession session, Followers followers, HttpServletRequest req, Model model,
			Following following, Post post) {
		this.userId = (int) session.getAttribute("uid");
	...
	public String Update(@ModelAttribute("user") User user, HttpSession session,
			@RequestParam("profile_pic") MultipartFile imageFile) throws IOException {
